...
$ji(document).ready(function () {
    ...
    $ji('body').append(
        ...
        '</div>' +
        '<div class="clear"></div>' +
        '<a title="Unlock Pro" href="https://www.iwdagency.com/extensions/magento-1-one-page-checkout-suite.html" target="_blank" class="iwd_free_opc_locked_button_small"><i class="fa fa-lock" aria-hidden="true"></i>Unlock Pro</a>' +
        '</div>' +
        '</div>'
    );
